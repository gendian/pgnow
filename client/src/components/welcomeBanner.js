...
export default function WelcomeBanner() {
    ...
    <div className="welcome-banner">
        ...
        <p>This site is dedicated to providing up to date information on exactly what is going on right now in Pokemon Go.</p>
        ...
        <p>Nothing about this site is monetized, I just hope it helps <BsEmojiLaughing/></p>
    </div>;
